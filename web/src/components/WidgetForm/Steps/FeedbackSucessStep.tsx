...
interface FeebackSucessStepProps {
  onFeedbackRestartRequested: () => void
}

export function FeebackSucessStep({
  onFeedbackRestartRequested,
}: FeebackSucessStepProps) {
  return (
    <>
      <header>
        <CloseButton />
      ...
      <div className="flex flex-col items-center py-10 w-[304px]">
        ...
        rounded-md border-transparent text-sm leading-6 hover:bg-zinc-700 transition-colors
